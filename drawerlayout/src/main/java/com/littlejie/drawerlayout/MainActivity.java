...
public class MainActivity extends Activity {
    ...
    private List<ItemInfo> generateItems() {
        ...
        items.add(new ItemInfo("DrawerLayout Demo", DrawerLayoutActivity.class));
        items.add(new ItemInfo("DrawerLayout 搭配 NavigationView Demo", NavigationActivity.class));
        return items;
    }
}
